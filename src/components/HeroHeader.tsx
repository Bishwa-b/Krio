...
//         <div className="flex justify-between items-center h-full text-krio-dark font-semibold">
//           {/* Brand Name */}
//           <Link to="/" className="flex items-center">
//             <span className="text-3xl md:text-4xl font-bold tracking-wider text-white hover:text-krio-orange transition-colors duration-300">
//               KRIO
//             </span>
//           </Link>
...
//                     isActive(link.path)
//                       ? "bg-krio-blue/30 font-medium text-black"
//                       : "text-black hover:bg-krio-blue hover:text-white"
//                   }`}
//                 >
//                   {link.label}
//                 </Link>
...
//                 <button
//                   aria-label="Search"
//                   className="text-black hover:text-krio-blue"
//                 >
//                   <Search size={24} />
//                 </button>
//                 <button
...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`absolute top-0 left-0 right-0 z-50 transition-all duration-300 bg-krio-main
        `}
      >
        <div className="relative container mx-auto px-4 md:px-8 flex items-center ">
      ...
      <div
        className={`fixed inset-0 bg-[#f8f5da] z-40 transform transition-transform duration-300 ease-in-out ${
...
const MobileNavLink = ({
  ...
  <Link
    to={to}
    onClick={onClick}
    className="font-display uppercase text-3xl tracking-tighter text-[#3b6326] hover:text-[#3b6326]/70 transition-colors relative group pb-1"
  >
    {children}
    <span className="absolute left-0 bottom-0 w-0 h-1 bg-[#3b6326] transition-all duration-300 group-hover:w-full"></span>
  </Link>
);
